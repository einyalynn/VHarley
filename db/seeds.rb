...
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/B-1_f.jpg',
              ...
              :horizontal =>false,
              :sequence => 2
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/B3.jpg',
              :title => "Mug of Quinoa",
              :portfolio => "food",
              :description => "",
              :visible =>true,
              :horizontal =>false,
              :sequence => 3
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/B4.jpg',
...
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/S-1_f.jpg',
              ...
              :horizontal =>false,
              :sequence => 21
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/T.jpg',
              ...
              :horizontal =>false,
              :sequence => 22
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/U.jpg',
              :title => "Baked Loaves",
              :portfolio => "food",
              :description => "",
              :visible =>true,
              :horizontal =>false,
              :sequence => 23
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/V.jpg',
              ...
              :horizontal =>false,
              :sequence => 24
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/X.jpg',
              :title => "Proved Loaves",
              :portfolio => "food",
              :description => "",
              :visible =>true,
...
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/article.jpg',
              :title => "Article", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 1

Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/press-1.jpg',
              :title => "Country Living - cover", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 2

Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/press-2.jpg',
              :title => "Country Living - interior", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 3

Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/press-3.jpg',
              :title => "Gardenalia - cover", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 4
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/press-4.jpg',
              :title => "Gardenalia - interior", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 5
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/2.jpg',
              :title => "English Home - Romantic Disposition", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 6
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/3.jpg',
              :title => "Interior Photos", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 7
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/4.jpg',
              :title => "Yorkshire Life - cover", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 8
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/5.jpg',
              :title => "Interior Photos", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 9
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/6.jpg',
              :title => "Interior Photos", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 10
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/7.jpg',
              :title => "Interior Photos", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 11
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/8.jpg',
              :title => "Great British Food - cover", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 12
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/9.jpg',
              :title => "Interior Photos", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 13
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/10.jpg',
              :title => "House & Garden - cover", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 14
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/11.jpg',
              :title => "Interior Photos", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 15
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/12.jpg',
              :title => "Le Journal du Patissier - cover", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 16
Photo.create! :url=>'http://drose.blob.core.windows.net/split-pin/13.jpg',
              :title => "Interior Photos", :portfolio => "published", :description => "", :visible =>true, :horizontal =>false,
              :sequence => 17
